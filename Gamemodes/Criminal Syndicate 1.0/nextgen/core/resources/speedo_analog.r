...
#if defined _speedo_analog_included
	#error "elready defined"
	#endinput
#endif

#define _speedo_analog_included
#pragma library speedo_analog
	#error "good good"
...
static
	...
	Text:SpeedoCircleTextType1[sizeof(SpeedoType1)][51],
	Text:SpeedoCircleTextType2[sizeof(SpeedoType2)][51],
	Text:SpeedoCircleTextType3[sizeof(SpeedoType3)][51],
	Text:SpeedoCircleTextType4[sizeof(SpeedoType4)][51],
	Text:SpeedoCircleTextType5[sizeof(SpeedoType5)][51],
	Text:SpeedoCircleTextType6[sizeof(SpeedoType6)][51],
	Text:SpeedoCircleTextType7[sizeof(SpeedoType7)][51],
	Text:SpeedoCircleTextType8[sizeof(SpeedoType8)][51],
	// fuel circle TextDraws
	Text:FuelCircleTextType1[sizeof(SpeedoType1)][11],
	Text:FuelCircleTextType2[sizeof(SpeedoType2)][11],
	Text:FuelCircleTextType3[sizeof(SpeedoType3)][11],
	Text:FuelCircleTextType4[sizeof(SpeedoType4)][11],
	Text:FuelCircleTextType5[sizeof(SpeedoType5)][11],
	Text:FuelCircleTextType6[sizeof(SpeedoType6)][11],
	Text:FuelCircleTextType7[sizeof(SpeedoType7)][11],
	Text:FuelCircleTextType8[sizeof(SpeedoType8)][11],
	// turbo circle TextDraws
	Text:TurboCircleTextType4[sizeof(SpeedoType4)][11],
	Text:TurboCircleTextType5[sizeof(SpeedoType5)][11],
	Text:TurboCircleTextType6[sizeof(SpeedoType6)][11],
	Text:TurboCircleTextType7[sizeof(SpeedoType7)][11],
	Text:TurboCircleTextType8[sizeof(SpeedoType8)][11],
	// speedo numerator
	Text:SpeedoNumeratorTextType2[sizeof(SpeedoType2)][11],
	Text:SpeedoNumeratorTextType3[sizeof(SpeedoType3)][11],
	Text:SpeedoNumeratorTextType5[sizeof(SpeedoType5)][11],
	Text:SpeedoNumeratorTextType6[sizeof(SpeedoType6)][11],
	Text:SpeedoNumeratorTextType7[sizeof(SpeedoType7)][11],
	Text:SpeedoNumeratorTextType8[sizeof(SpeedoType8)][11],
	// fuel numerator
	Text:FuelNumeratorTextType3[sizeof(SpeedoType3)][11],
	Text:FuelNumeratorTextType6[sizeof(SpeedoType6)][11],
	Text:FuelNumeratorTextType7[sizeof(SpeedoType7)][11],
	// turbo numerator
...
stock SpeedometerAnalogUpdate(playerid,type,speedoid,data[3])
{
	switch(type)
	{
		case 0:
		{
			ShowAnalogIdentSpeed(playerid,SpeedoType1[speedoid][sSpeedoPos][3],SpeedoType1[speedoid][sSpeedoPos][0],SpeedoType1[speedoid][sSpeedoPos][1],SpeedoType1[speedoid][sSpeedoPos][2],SpeedoType1[speedoid][sColor],data[0]);
			ShowAnalogIdentFuel(playerid,SpeedoType1[speedoid][sFuelPos][3],SpeedoType1[speedoid][sFuelPos][0],SpeedoType1[speedoid][sFuelPos][1],SpeedoType1[speedoid][sFuelPos][2],SpeedoType1[speedoid][sColor],data[1]);
		}
		case 1:
		{
			ShowAnalogIdentSpeed(playerid,SpeedoType2[speedoid][sSpeedoPos][3],SpeedoType2[speedoid][sSpeedoPos][0],SpeedoType2[speedoid][sSpeedoPos][1],SpeedoType2[speedoid][sSpeedoPos][2],SpeedoType2[speedoid][sColor],data[0]);
			ShowAnalogIdentFuel(playerid,SpeedoType2[speedoid][sFuelPos][3],SpeedoType2[speedoid][sFuelPos][0],SpeedoType2[speedoid][sFuelPos][1],SpeedoType2[speedoid][sFuelPos][2],SpeedoType2[speedoid][sColor],data[1]);
		}
		case 2:
		{
			ShowAnalogIdentSpeed(playerid,SpeedoType3[speedoid][sSpeedoPos][3],SpeedoType3[speedoid][sSpeedoPos][0],SpeedoType3[speedoid][sSpeedoPos][1],SpeedoType3[speedoid][sSpeedoPos][2],SpeedoType3[speedoid][sColor],data[0]);
			ShowAnalogIdentFuel(playerid,SpeedoType3[speedoid][sFuelPos][3],SpeedoType3[speedoid][sFuelPos][0],SpeedoType3[speedoid][sFuelPos][1],SpeedoType3[speedoid][sFuelPos][2],SpeedoType3[speedoid][sColor],data[1]);
		}
		case 3:
		{
			ShowAnalogIdentSpeed(playerid,SpeedoType4[speedoid][sSpeedoPos][3],SpeedoType4[speedoid][sSpeedoPos][0],SpeedoType4[speedoid][sSpeedoPos][1],SpeedoType4[speedoid][sSpeedoPos][2],SpeedoType4[speedoid][sColor],data[0]);
			ShowAnalogIdentFuel(playerid,SpeedoType4[speedoid][sFuelPos][3],SpeedoType4[speedoid][sFuelPos][0],SpeedoType4[speedoid][sFuelPos][1],SpeedoType4[speedoid][sFuelPos][2],SpeedoType4[speedoid][sColor],data[1]);
			ShowAnalogIdentTurbo(playerid,SpeedoType4[speedoid][sTurboPos][3],SpeedoType4[speedoid][sTurboPos][0],SpeedoType4[speedoid][sTurboPos][1],SpeedoType4[speedoid][sTurboPos][2],SpeedoType4[speedoid][sColor],data[2]);
		}
		case 4:
		{
			ShowAnalogIdentSpeed(playerid,SpeedoType5[speedoid][sSpeedoPos][3],SpeedoType5[speedoid][sSpeedoPos][0],SpeedoType5[speedoid][sSpeedoPos][1],SpeedoType5[speedoid][sSpeedoPos][2],SpeedoType5[speedoid][sColor],data[0]);
			ShowAnalogIdentFuel(playerid,SpeedoType5[speedoid][sFuelPos][3],SpeedoType5[speedoid][sFuelPos][0],SpeedoType5[speedoid][sFuelPos][1],SpeedoType5[speedoid][sFuelPos][2],SpeedoType5[speedoid][sColor],data[1]);
			ShowAnalogIdentTurbo(playerid,SpeedoType5[speedoid][sTurboPos][3],SpeedoType5[speedoid][sTurboPos][0],SpeedoType5[speedoid][sTurboPos][1],SpeedoType5[speedoid][sTurboPos][2],SpeedoType5[speedoid][sColor],data[2]);
		}
		case 5:
		{
			ShowAnalogIdentSpeed(playerid,SpeedoType6[speedoid][sSpeedoPos][3],SpeedoType6[speedoid][sSpeedoPos][0],SpeedoType6[speedoid][sSpeedoPos][1],SpeedoType6[speedoid][sSpeedoPos][2],SpeedoType6[speedoid][sColor],data[0]);
			ShowAnalogIdentFuel(playerid,SpeedoType6[speedoid][sFuelPos][3],SpeedoType6[speedoid][sFuelPos][0],SpeedoType6[speedoid][sFuelPos][1],SpeedoType6[speedoid][sFuelPos][2],SpeedoType6[speedoid][sColor],data[1]);
			ShowAnalogIdentTurbo(playerid,SpeedoType6[speedoid][sTurboPos][3],SpeedoType6[speedoid][sTurboPos][0],SpeedoType6[speedoid][sTurboPos][1],SpeedoType6[speedoid][sTurboPos][2],SpeedoType6[speedoid][sColor],data[2]);
		}
		case 6:
		{
			ShowAnalogIdentSpeed(playerid,SpeedoType7[speedoid][sSpeedoPos][3],SpeedoType7[speedoid][sSpeedoPos][0],SpeedoType7[speedoid][sSpeedoPos][1],SpeedoType7[speedoid][sSpeedoPos][2],SpeedoType7[speedoid][sColor],data[0]);
			ShowAnalogIdentFuel(playerid,SpeedoType7[speedoid][sFuelPos][3],SpeedoType7[speedoid][sFuelPos][0],SpeedoType7[speedoid][sFuelPos][1],SpeedoType7[speedoid][sFuelPos][2],SpeedoType7[speedoid][sColor],data[1]);
			ShowAnalogIdentTurbo(playerid,SpeedoType7[speedoid][sTurboPos][3],SpeedoType7[speedoid][sTurboPos][0],SpeedoType7[speedoid][sTurboPos][1],SpeedoType7[speedoid][sTurboPos][2],SpeedoType7[speedoid][sColor],data[2]);
		}
		case 7:
		{
			ShowAnalogIdentSpeed(playerid,SpeedoType8[speedoid][sSpeedoPos][3],SpeedoType8[speedoid][sSpeedoPos][0],SpeedoType8[speedoid][sSpeedoPos][1],SpeedoType8[speedoid][sSpeedoPos][2],SpeedoType8[speedoid][sColor],data[0]);
			ShowAnalogIdentFuel(playerid,SpeedoType8[speedoid][sFuelPos][3],SpeedoType8[speedoid][sFuelPos][0],SpeedoType8[speedoid][sFuelPos][1],SpeedoType8[speedoid][sFuelPos][2],SpeedoType8[speedoid][sColor],data[1]);
			ShowAnalogIdentTurbo(playerid,SpeedoType8[speedoid][sTurboPos][3],SpeedoType8[speedoid][sTurboPos][0],SpeedoType8[speedoid][sTurboPos][1],SpeedoType8[speedoid][sTurboPos][2],SpeedoType8[speedoid][sColor],data[2]);
		}
	}
}
...
static ShowAnalogIdentSpeed(playerid,Float:A,Float:X,Float:Y,Float:R,color,data)
{
	new Float:Ang,
		Float:poX,
		Float:poY,
...
static ShowAnalogIdentFuel(playerid,Float:A,Float:X,Float:Y,Float:R,color,data)
{
	new Float:Ang,
		Float:offs,
		Float:poX,
...
static ShowAnalogIdentTurbo(playerid,Float:A,Float:X,Float:Y,Float:R,color,data)
{
	new Float:Ang,
		Float:offs,
		Float:poX,

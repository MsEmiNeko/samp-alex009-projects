...
#if defined _speedo_electro_included
	#error "Fucked error"
	#endinput
#endif

#define _speedo_electro_included
#pragma library speedo_electro
...
stock SpeedometerElectroUpdate(playerid,type,speedoid,data[3])
{
	switch(type)
	{
		case 0:
		{
			ShowElectroIdentSpeed(playerid,0,SpeedoType1[speedoid][sSpeedoPos][0],SpeedoType1[speedoid][sSpeedoPos][1],SpeedoType1[speedoid][sSpeedoColor],SpeedoType1[speedoid][sTextStyle],data[0]);
			ShowElectroIdentFuel(playerid,0,SpeedoType1[speedoid][sFuelPos][0],SpeedoType1[speedoid][sFuelPos][1],SpeedoType1[speedoid][sFuelColor],SpeedoType1[speedoid][sTextStyle],data[1]);
		}
		case 1:
		{
			ShowElectroIdentSpeed(playerid,1,SpeedoType2[speedoid][sSpeedoPos][0],SpeedoType2[speedoid][sSpeedoPos][1],SpeedoType2[speedoid][sSpeedoColor],SpeedoType2[speedoid][sTextStyle],data[0]);
			ShowElectroIdentFuel(playerid,1,SpeedoType2[speedoid][sFuelPos][0],SpeedoType2[speedoid][sFuelPos][1],SpeedoType2[speedoid][sFuelColor],SpeedoType2[speedoid][sTextStyle],data[1]);
		}
		case 2:
		{
			ShowElectroIdentSpeed(playerid,0,SpeedoType3[speedoid][sSpeedoPos][0],SpeedoType3[speedoid][sSpeedoPos][1],SpeedoType3[speedoid][sSpeedoColor],SpeedoType3[speedoid][sTextStyle],data[0]);
			ShowElectroIdentFuel(playerid,0,SpeedoType3[speedoid][sFuelPos][0],SpeedoType3[speedoid][sFuelPos][1],SpeedoType3[speedoid][sFuelColor],SpeedoType3[speedoid][sTextStyle],data[1]);
			ShowElectroIdentTurbo(playerid,0,SpeedoType3[speedoid][sTurboPos][0],SpeedoType3[speedoid][sTurboPos][1],SpeedoType3[speedoid][sTurboColor],SpeedoType3[speedoid][sTextStyle],data[2]);
		
		}
		case 3:
		{
			ShowElectroIdentSpeed(playerid,1,SpeedoType4[speedoid][sSpeedoPos][0],SpeedoType4[speedoid][sSpeedoPos][1],SpeedoType4[speedoid][sSpeedoColor],SpeedoType4[speedoid][sTextStyle],data[0]);
			ShowElectroIdentFuel(playerid,1,SpeedoType4[speedoid][sFuelPos][0],SpeedoType4[speedoid][sFuelPos][1],SpeedoType4[speedoid][sFuelColor],SpeedoType4[speedoid][sTextStyle],data[1]);
			ShowElectroIdentTurbo(playerid,1,SpeedoType4[speedoid][sTurboPos][0],SpeedoType4[speedoid][sTurboPos][1],SpeedoType4[speedoid][sTurboColor],SpeedoType4[speedoid][sTextStyle],data[2]);
		}
	}
}
...
// local utils
// --------------------------------------------------
static ShowElectroIdentSpeed(playerid,type,Float:X,Float:Y,color,style,data)
{
	printf("called %d",data);
	if((PlayerTextSpeed[playerid] == INVALID_TEXT_DRAW) || (PlayerDataSpeed[playerid] != data))
	{
		...
		switch(type)
		{
			...
			case 1:
			{
				for(new i = 0;i < (data / 10);i++)
				{
					printf("%d - [%s]",i,val);
					format(val,sizeof(val),"%s%c",val,style);
				}
			}
		}
...
static ShowElectroIdentFuel(playerid,type,Float:X,Float:Y,color,style,data)
{
...
static ShowElectroIdentTurbo(playerid,type,Float:X,Float:Y,color,style,data)
{
